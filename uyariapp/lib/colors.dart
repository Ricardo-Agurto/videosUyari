...
/** clase define colores para la aplicacion**/
class AppColore {
  ...
  static Color homePageContainerTextSmall = const Color(0xFF302f51);
  static Color homePageContainerTextBig = const Color(0xFFffffff);
  static Color homePagePlanColor = const Color(0xFF302f51);
  static Color secondPageTopIconcolor = const Color(0xFFb7bce8);
  static Color secondPageTitleColor = const Color(0xFFfefeff);
  static Color secondPageContainerGradient1stColor = const Color(0xFF6985c7);
